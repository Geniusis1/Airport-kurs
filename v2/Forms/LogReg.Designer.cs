namespace Airport_kurs
{
    partial class LogReg
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lgPassTb = new System.Windows.Forms.TextBox();
			...
			this.loginPage.Controls.Add(this.lgPassTb);
			...
			this.lgLoginBt.Click += new System.EventHandler(this.lgLoginBt_Click);
			// 
			// lgPassTb
			// 
			this.lgPassTb.Location = new System.Drawing.Point(51, 117);
			this.lgPassTb.Name = "lgPassTb";
			this.lgPassTb.Size = new System.Drawing.Size(178, 22);
			this.lgPassTb.TabIndex = 3;
			this.lgPassTb.UseSystemPasswordChar = true;
			// 
			// lgPassLb
			// 
        ...
        private System.Windows.Forms.TextBox lgPassTb;
